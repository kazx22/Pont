...
const BlogCard = ({ image, date, heading, text, path }) => {
  ...
  return (
    <div className="relative flex-col w-[400px] h-[600px] mt-5 bg-[#e0d8cb]">
      <div className="relative">
        <Image src={image} alt="Blog" className="w-[400px] h-[300px]" />
      </div>
      ...
      <div className="w-[300px] h-[50px] bg-[#F2F0EB] rounded-l m-auto absolute left-1/2 mt-[-20px] ml-[-150px] flex justify-center items-center gap-1 z-10">
        ...
        />
        <p className="text-[12px] font-medium font-popins mt-1">{date}</p>
        <FontAwesomeIcon
          icon={faComment}
      ...
      <div className="text-center">
        <Link href={path} passHref>
          <button className="mt-4 px-8 py-4  bg-summer-org text-white font-semibold rounded-[50px] hover:bg-green-700">
            Read More
          </button>
        </Link>
      </div>
